...
/**
 * Inter-module communication bus. Works as a blackboard where modules can
...
public class ModuleCommunicationBus {
	...
	public void subscribe(String key, ModuleCommunicationListener module) {
        ...
        List<ModuleCommunicationListener> list = this.listeners.computeIfAbsent(key, k -> new ArrayList<>(INIT_CAPACITY));
