...
public class BusControlSystem {
	...
	/**
	 * Called by buses belonging to this system every time the bus has stopped.
	 * It calls every passenger's enterBus() method so that the passengers can
	...
	public void busHasStopped(int busID, Coord busStop, Path nextPath) {
        for (BusTravellerMovement traveller : travellers.values()) {
