...
public class PlayField extends JPanel {
	...
	public PlayField (World w, DTNSimGUI gui) {
        ...
        this.overlayGraphics = Collections.synchronizedList(new ArrayList<>());
	...
	/**
	 * Sets whether the view should focus on the specified
	 * area on click
	 * @param focus Focus on Click is enabled if this is true, disabled on false
	 */
	...
	/**
	 * Clears overlay graphics if auto clear is requested
	...
	/**
	 * Updates the play fields (graphical) size to match the world's size
	 ...
	 * (in the graphic view of the play field)
